(function() {
    ...
    const knowledgeBase = [
        ...
        },
        {
            ...
            response: "<strong>Priority Support:</strong><br>For critical infrastructure failures, call Operations Command at <strong>816-787-2061</strong>.<br>For non-urgent tickets, use the <a href='contact.html' style='color:#B8953A;'>Contact Form</a>."
        },
        {
